package core.casalib {
	 ...
	 */
	public class CasaBitmapExtended extends CasaBitmap implements IDestroyableObjectsManager {
		private var _objectManager:DestroyableObjectsManager;

		/**
		 * Конструктор.
		 */
		public function CasaBitmapExtended(bitmapData:BitmapData = null, pixelSnapping:String = "auto", smoothing:Boolean = false) {
